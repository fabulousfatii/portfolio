 ...
 useGSAP(()=>{
  ...
  return (
   <main className='min-w-screen-sm scroll-smooth'>
    <motion.nav initial={{ y:400}} animate={{y:0}} transition={{duration:1.5}} className='fixed right-2'>
...
<section id='home' className='lg:w-full md:w-full h-full  bgskill'>
     ...
     <div className='py-16 px-32 flex flex-col gap-2 max-sm:px-3'>
      <div className='w-[250px] h-[250px] bg m-4'></div>
       <motion.h2  initial={{ x:-400}} animate={{x:0}} transition={{duration:1.5}} className='name text-5xl font-normal max-sm:text-2xl   '>Fatima Saleem</motion.h2>
       <h1 className='skill text-6xl font-bold mx-1 font-["Mulish"]'>Frontend Developer</h1>
        <motion.button initial={{ x:800}} animate={{x:0}} transition={{duration:1.5}} className='p-3 w-52   bg-gray-200 bg-opacity-20 rounded-2xl hover:bg-orange-700 duration-2 hover:border-white '>
          <a  href='#skills' className='text-white text-xl font-semibold'>Explore</a>
        </motion.button>
     </div>
