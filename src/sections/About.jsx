...
function About() {
  ...
  useGSAP(()=>{
    ...
    gsap.to("#about",{
      // background:"#700d22",
      background: "rgb(36,16,3)",
      background: "linear-gradient(117deg, rgba(36,16,3,1) 18%, rgba(166,16,42,1) 64%)",
      duration:2,
      scrollTrigger:{
        trigger:"#about",
        scroll:"body",
    ...
    <motion.h1 initial={{opacity:0,}}
                     whileInView={{opacity:100, transition:{duration:1.5} }}  className='p-6 pt-8 text-6xl font-bold text-center '> About me</motion.h1>
